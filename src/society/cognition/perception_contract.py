...
class Perception:
    ...
    shelf_line: str | None = None            # いま居る店の棚の様子(INV-A。非潤沢のときだけ)
    ...
    #: 既定 OFF は None = 1 行も足さない(snc_section と完全同型の seam)。
...
_KW_FIELDS: tuple[tuple[str, str, bool], ...] = (
    ...
    ("attention_section", "attention_section", False),
